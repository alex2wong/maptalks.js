...
(function (global, factory) {
    ...
    var UIMarker = function (_Handlerable) {
      ...
      _proto._syncPitchRotate = function _syncPitchRotate() {
        if (Browser$1.ie9) return;
        var dom = this.getDOM();
        var markerRotate = -this.getMap().getBearing();
    ...
    typeof console !== 'undefined' && console.log && console.log('maptalks v0.40.5');
